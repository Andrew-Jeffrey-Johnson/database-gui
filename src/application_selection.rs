...
pub struct ApplicationSelection {
    ...
    pub achievement_variant_id: i32,
}
impl ApplicationSelection {
    pub fn new() -> Self {
        Self {
            id: 0,
            application_id: 0,
            achievement_variant_id: 0,
        }
    }
    pub fn reset(&mut self) {
        self.id = 0;
        self.application_id = 0;
        self.achievement_variant_id = 0;
    }
    pub fn fetch_many(offset: i32, max: i32) -> Vec<Self> {
        ...
        for row in rows {
            let element = Self {
                ...
                achievement_variant_id: row.get::<i32, usize>(2),
            };
    ...
    pub fn insert_into_db(&mut self) -> i32 {
        let expr = format!("
            INSERT INTO application_selection 
                (
                application_id,
                achievement_variant_id,
                ) 
